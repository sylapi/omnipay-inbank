        ...
        Contracts\ContractSigningRequestContract
{
    ...
    public function sendData($data)
    {
        ...
        try {
            ...
            return new ContractSigningResponse($this, $response);
